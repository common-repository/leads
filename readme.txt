...
= 3.2.9 =
* Updating CTAs for Inbound Now PRO

= 3.2.7 =
* Upgrading inner GPL assets.

= 3.2.6 =
* Updating readme.txt compatibility

= 3.2.5 =
* Fixing double-optin confirmation page setting option
...
= 3.2.2 =
* Adding sanitization for better security.
